...
\begin{frame}
	...
	\begin{block}{Quelques dates clés à retenir}
		\begin{itemize}
			\item<1-> \textbf{1965 : } Invention du langage \textit{hypertexte} (Ted Nelson) qui permet de connecter entre eux divers documents.
			\item<2-> \textbf{1989 : } Naissance officiel du web crée par Tim Berners-Lee au {\sc cern } de Genève.
			\item<3-> \textbf{1993 : } Ouverture du code source des technologies du web ce qui permet sans doute son développement rapide.
			\item<4-> \textbf{1994 : } Création du W3C, organisme en charge de la standardisation des langages et technologies du web.
			\item<5-> \textbf{1995 : } Web interactif avec des technologies publiques. Javascript côté client et {\sc php} côté serveur.
			\item<7-> \textbf{2001 : } Standardisation des pages avec un modèle en arbre pour les documents : le {\sc dom}.
			\item<8-> \textbf{2010 : } Développement du \textit{Web} sur mobiles.
		\end{itemize}
	\end{block}
\end{frame}
