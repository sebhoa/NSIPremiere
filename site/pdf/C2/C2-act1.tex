...
\ModeActivite
\Activites{\debase\; -- C3 : Représentation des entiers positifs}{\Pre}
...
\hline
\rule{0pt}{64px}\includegraphics[scale=1]{images/pascal.eps} & \includegraphics[scale=1]{images/leibniz.eps} \\
\hline
