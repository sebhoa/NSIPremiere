...
\begin{frame}
	...
	\begin{block}{La place du système d'exploitation}
		...
		\begin{tabularx}{0.9\textwidth}{Y}
			\onslide<2->{\rnode{ut}{\psshadowbox{\makebox[5cm]{\par\noindent\rule[-0.2cm]{0pt}{0.6cm} \textcolor{red}{\textbf{L'utilisateur}} }} } }              \\
			\\
			\onslide<3->{\rnode{ap}{\psshadowbox{\makebox[5cm]{\par\noindent\rule[-0.2cm]{0pt}{0.6cm} {\textcolor{red}{\textbf{Les applications}} } }}}}            \\
			\\
			\onslide<6->{\rnode{os}{\psshadowbox{\makebox[5cm]{\par\noindent\rule[-0.2cm]{0pt}{0.6cm} {\textcolor{red}{\textbf{Système d'exploitation}}} }}}} \\
			\\
			\onslide<6->{\rnode{or}{\psshadowbox{\makebox[5cm]{\par\noindent\rule[-0.2cm]{0pt}{0.6cm} {\textcolor{red}{\textbf{L'ordinateur}}} }}}}
		\end{tabularx}
...
\begin{frame}
	...
	\begin{block}{Libres et propriétaires}
		...
		\begin{itemize}
			\item<1-> Les systèmes d'exploitation \textcolor{blue}{propriétaires} développé par une société dans un but commercial. Par exemple Windows ou MacOS.
			      \onslide<2->{Les utilisateurs n'ont alors pas le droit ni de modifier, ni de revendre le système d'exploitation.}
			      \onslide<3->{En particulier, ils n'ont pas accès au \textcolor{blue}{code source}}.
			\item<4-> Les systèmes d'exploitation \textcolor{blue}{libres} développé par une communauté d'informaticiens. Par exemple Linux.
			      \onslide<5->{Le code source est fourni (\textit{open source}), mais libre n'est pas synonyme de gratuit.}
		\end{itemize}
	\end{block}
\end{frame}
